...
"git diff
nmap <D-F6> :!git diff HEAD -- <C-R>=expand("%:p")<CR> &<CR>
nmap <D-F7> :let tmp = GetVer()<CR>:exe '!git diff ' . tmp[1] . ' -- <C-R>=expand("%:p")<CR> &'<CR>
nmap <D-F8> :let tmp = GetVer()<CR>:exe '!git diff ' . tmp[1] . tmp[0] . ' -- <C-R>=expand("%:p")<CR> &'<CR>
